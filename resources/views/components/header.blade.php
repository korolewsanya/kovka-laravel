<header class="navbar bg-base-100 shadow-lg sticky top-0 z-50 px-1 sm:px-4">
    {{-- Логотип слева --}}
    <div class="navbar-start w-1/4 max-sm:w-[32%]">
    ...
    {{-- Поиск по центру --}}
    <div class="navbar-center w-1/2 flex justify-center max-sm:w-[22%]">
        <div class="w-full max-w-xs max-sm:max-w-15">
            <livewire:search />
        </div>
    </div>

    {{-- Телефон справа --}}
    <div class="navbar-end w-1/4 flex justify-end max-sm:w-[32%]">
